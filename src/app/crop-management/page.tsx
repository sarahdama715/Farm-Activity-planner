export default function CropManagement() {
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-4xl font-bold text-black">Crop Management</h1>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-black">Your Crops</h2>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                <th className="px-6 py-3 text-left text-sm font-semibold text-black">Crop Type</th>
                <th className="px-6 py-3 text-left text-sm font-semibold text-black">Area (acres)</th>
                <th className="px-6 py-3 text-left text-sm font-semibold text-black">Planting Date</th>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="font-semibold text-black">Total Crops</h3>
          <p className="text-3xl font-bold text-green-600 mt-2">0</p>
        </div>
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="font-semibold text-black">Total Area</h3>
          <p className="text-3xl font-bold text-blue-600 mt-2">0 acres</p>
        </div>
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="font-semibold text-black">Avg. Health</h3>
