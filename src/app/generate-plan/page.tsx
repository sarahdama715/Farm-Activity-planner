...
export default function GeneratePlan() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-4xl font-bold text-black">Generate Plan</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <select
              ...
              className="mt-2 w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-black"
            >
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
        <h3 className="font-semibold text-black">What will be generated?</h3>
