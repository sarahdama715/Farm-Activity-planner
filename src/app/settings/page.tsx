    ...
    <div className="space-y-8">
      ...
      <div className="max-w-2xl space-y-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h2 className="text-xl font-bold text-black mb-4">Farm Information</h2>
          <form className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-black">Farm Name</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-black">Total Farm Size (acres)</label>
              <input
                type="number"
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="notifications" className="ml-3 text-black">
            ...
            <div className="flex items-center">
              <input
                ...
                className="h-4 w-4 text-green-600 rounded focus:ring-2 focus:ring-green-500"
              />
              <label htmlFor="reminders" className="ml-3 text-black">
            ...
            <div className="flex items-center">
              <input
                ...
                className="h-4 w-4 text-green-600 rounded focus:ring-2 focus:ring-green-500"
              />
              <label htmlFor="darkMode" className="ml-3 text-black">
                Dark mode
              </label>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-black mb-4">Manage your account settings and preferences.</p>
